    ...
    <div className="bg-slate-950 text-slate-200 antialiased overflow-x-hidden">
      ...
      >
        <div className="max-w-7xl mx-auto flex justify-between items-center px-6 py-4">
          ...
          <a
            href="#cta"
            className="relative group bg-gradient-to-r from-blue-600 to-blue-500 text-white px-5 py-2.5 rounded-full font-semibold shadow-lg shadow-blue-500/25 hover:shadow-blue-500/50 transition-all duration-200 hover:-translate-y-0.5"
          >
            Get started free
          </a>
        </div>
      ...
      <section className="relative pt-32 pb-24 px-6 overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto text-center relative">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
            <a
              href="#cta"
              className="group relative inline-flex items-center gap-2 bg-gradient-to-r from-blue-600 to-blue-500 text-white px-8 py-4 rounded-full font-semibold text-lg shadow-lg shadow-blue-500/30 hover:shadow-blue-500/50 transition-all duration-200 hover:-translate-y-0.5"
            >
              <RocketLaunch className="text-white" size={20} weight="fill" />
              Start free in 30 seconds
            </a>
            <a
              href="#demo"
              className="inline-flex items-center gap-2 px-8 py-4 rounded-full font-semibold text-slate-300 border border-slate-700 hover:bg-slate-800 transition duration-200"
            >
              <PlayCircle size={20} />
              See how it works
            </a>
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            <div className="bg-slate-900/50 backdrop-blur-sm border border-slate-800 rounded-3xl p-8 hover:bg-slate-900/80 transition duration-300 hover:border-slate-700 group">
              ...
              <p className="text-slate-400 leading-relaxed">
                Respond to reviews faster with AI-generated drafts matching your brand tone.
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="py-16 px-6">
        <div className="max-w-4xl mx-auto text-center">
          <h2 className="text-2xl sm:text-3xl font-bold text-white mb-8">
            Built for businesses where <span className="bg-gradient-to-r from-blue-400 to-emerald-400 bg-clip-text text-transparent">Google ranking = revenue</span>
          </h2>
      ...
      <section ref={statsRef} className="py-20 px-6 bg-slate-900/30">
        <div className="max-w-5xl mx-auto text-center">
          ...
          <div className="grid sm:grid-cols-3 gap-8">
            {[
              { value: 47, suffix: "%", desc: "more Google reviews within 30 days", prefix: "+" },
              { value: 82, suffix: "%", desc: "negative public reviews caught early", prefix: "-" },
              { value: 12, suffix: " min", desc: "average setup time", prefix: "" },
            ].map((stat, idx) => (
              <div key={idx} className="flex flex-col items-center">
                <span className="text-5xl sm:text-6xl font-extrabold bg-gradient-to-b from-white to-slate-400 bg-clip-text text-transparent">
                  {stat.prefix}
                  <span className="tabular-nums">
                    {animatedStats ? <CountUp end={stat.value} duration={2000} /> : 0}
                  </span>
                  {stat.suffix}
                </span>
          ...
          <div className="flex justify-center gap-2 mb-8">
            {["widget", "dashboard", "flow"].map((tab) => (
              <button
                ...
                className={`px-5 py-2 rounded-full font-medium text-sm transition border backdrop-blur-sm ${
                  demoTab === tab
      ...
      <section className="py-24 px-6 bg-slate-900/30">
        <div className="max-w-6xl mx-auto text-center">
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
            {[
              { quote: "Our Google rating went from 3.8 to 4.6 in one month. This tool paid for itself instantly.", author: "Maria K.", role: "Dentist" },
              { quote: "I installed it during my lunch break. The free tier alone doubled our reviews.", author: "David L.", role: "Plumber" },
              { quote: "The private feedback saved us from a bad public review. Worth every penny.", author: "Jasmine R.", role: "Salon Owner" },
            ].map((t, i) => (
        ...
        <div className="max-w-2xl mx-auto">
          ...
          {[
            ...
            },
            {
              ...
              answer: "Absolutely. We never post fake reviews, filter content, or offer incentives. We simply route genuine sentiment – public praise goes to Google, private feedback to your inbox. This is fully compliant with Google’s review policies and the FTC’s new rule."
            },
            {
            ...
            <div key={idx} className="border-b border-slate-800 py-5">
              <button
                ...
                className="w-full flex justify-between items-center text-left font-semibold text-lg text-white hover:text-blue-400 transition"
              >
                {item.question}
                <CaretDown
                  className={`transform transition duration-200 ${openFaq === idx ? "rotate-180" : ""}`}
                  size={20}
                />
              </button>
      ...
      <section id="cta" className="py-24 px-6 relative">
        ...
        <div className="max-w-3xl mx-auto text-center relative">
          ...
          <h2 className="text-4xl sm:text-5xl font-bold text-white mb-4">
            Ready to turn happy customers
            <br />
            into <span className="bg-gradient-to-r from-blue-400 to-emerald-400 bg-clip-text text-transparent">public reviews</span>?
          </h2>
          <p className="text-lg text-slate-400 max-w-xl mx-auto mb-8">
            Get 25 reviews/month, 5 AI drafts, and the smart routing widget – free, no credit card needed. Setup takes 30 seconds.
          </p>
          <a
            href="#"
            className="group relative inline-flex items-center gap-2 bg-gradient-to-r from-blue-600 to-blue-500 text-white px-10 py-4 rounded-full font-semibold text-lg shadow-xl shadow-blue-500/30 hover:shadow-blue-500/60 transition-all hover:-translate-y-0.5"
          >
            <RocketLaunch weight="fill" size={22} />
